...
| `service.requireSuperAdmin` | 只有管理员能做的领域动作：`ListUsers`、`EditUser`、`GetUserResources`、`SetUserResources`、`ListPlans`、`AssociatePlan`、`AddNode`、`AddChainGroup`、`DelChainGroup` |
